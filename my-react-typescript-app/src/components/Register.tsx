...
const validation = (nama: string, username: string, email: string, password: string, confirmPassword: string): ErrorMessage => {
...
const RegisterPage = () => {
  ...
  const handleSubmited = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const validateError = validation(nama, username, email, password, confirmPassword);
      ...
      <div className="p-4">
        ...
        <form onSubmit={handleSubmited}>
          <div className="mb-4">
            ...
            <input type="text" id="nama" name="nama" className="px-3 py-1.5 mt-1 w-full border border-gray-300 rounded-lg focus:outline-1 focus:outline-blue-600 focus:border-blue-600" />
          ...
          <div className="mb-4">
            ...
            <input type="text" id="email" name="email" className="px-3 py-1.5 mt-1 w-full border border-gray-300 rounded-lg focus:outline-1 focus:outline-blue-600 focus:border-blue-600" />
          ...
          <div className="mb-6">
            ...
            <input type="password" id="confirm_password" name="confirm_password" className="px-3 py-1.5 mt-1 w-full border border-gray-300 rounded-lg focus:outline-1 focus:outline-blue-600 focus:border-blue-600" />
